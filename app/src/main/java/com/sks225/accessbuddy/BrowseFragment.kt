...
import com.sks225.accessbuddy.databinding.FragmentBrowseBinding
...
//        }
    ...
    override fun onCreateContextMenu(
        ...
        when (result.type) {
            ...
            WebView.HitTestResult.SRC_ANCHOR_TYPE, WebView.HitTestResult.ANCHOR_TYPE -> {
                menu.add("Open in New com.sks225.accessbuddy.model.Tab")
                menu.add("Open com.sks225.accessbuddy.model.Tab in Background")
                menu.add("Share")
                menu.add("Close")
            }
    ...
    override fun onContextItemSelected(item: MenuItem): Boolean {
        ...
        when (item.title) {
            "Open in New com.sks225.accessbuddy.model.Tab" -> {
                changeTab(url.toString(), BrowseFragment(url.toString()))
            }

            "Open com.sks225.accessbuddy.model.Tab in Background" -> {
