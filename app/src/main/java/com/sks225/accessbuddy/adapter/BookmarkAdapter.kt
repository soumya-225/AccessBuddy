...
import com.sks225.accessbuddy.BrowseFragment
import com.sks225.accessbuddy.MainActivity
import com.sks225.accessbuddy.changeTab
import com.sks225.accessbuddy.checkForInternet
import com.sks225.accessbuddy.databinding.BookmarkViewBinding
import com.sks225.accessbuddy.databinding.LongBookmarkViewBinding
    ...
    override fun onBindViewHolder(holder: MyHolder, position: Int) {
        try {
            ...
            if (MainActivity.bookmarkList[position].imagePath != null) {
                holder.image.background = ResourcesCompat.getDrawable(
                    context.resources,
                    MainActivity.bookmarkList[position].imagePath!!,
                    context.theme
                )
            } else {
